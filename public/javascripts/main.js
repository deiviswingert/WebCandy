...
var Compra = function (data, periodo, valor) {
    this.data = data;
    this.periodo = periodo;
    this.valor = ko.observable(valor);  
    this.cssClass = ko.computed(function (valor) {
        return valor > 50 ? "xuxu2" : "xuxu";
    })
}
...
var viewModel = {
    compras: [
        new Compra(new Date().getDate(), "02/02 - 16/02", "R$: 60,00"),
        new Compra(new Date().getDate(), "16/02 - 05/03", "R$: 50,00"),
        new Compra(new Date().getDate(), "05/03 - 16/03", "R$: 50,00")
        ]
